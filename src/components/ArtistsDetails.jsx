...
const ArtistsDetails = () => {
  ...
  document.title = `${title ? title : "Dreamly5 Music"}`;
  // console.log(details);
  // console.log(details);
  // console.log(page)
  // console.log(hasMore)
  ...
  return details.length ? (
    ...
    >
      ...
      <div className="w-full fixed z-[99] backdrop-blur-xl flex items-center gap-3 sm:h-[7vh]  h-[10vh]">
        ...
        ></i>
        <h1 className="text-xl text-zinc-300 font-black">Dreamly5 Music</h1>
      </div>
      ...
      {/* <div className="w-full text-white p-10 sm:p-3 sm:gap-3 h-[65vh] overflow-y-auto flex sm:block flex-wrap gap-7 justify-center ">
        ...
        <div className="flex gap-3 text-2xl  ">
          <h1>MADE BY ❤️ MUKESH B</h1>
          <a
            target="_blank"
            href="https://www.instagram.com/dreamlyfive/"
          >
